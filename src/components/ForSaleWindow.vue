  ...
  <div class="forSaleWindow">
    <div class="forSaleWrapper">
      ...
      <div class="forSaleLots">
        <div class="listLots">
          <div class="gridLots">
            <div v-for="lot in script.lots" :key="lot.index" class="blockLot">
              <div class="wrapperLot">
                ...
                <div class="rightSubBlock">
                  <div class="UpRightSubBlock">
                    ...
                    <div class="addItems">
                      <div v-for="(imageName, imgIndex) in lot[6]" :key="imgIndex" class="addItem">
                        <img :src="getImagePathChild(imageName)">
                      </div>
                    </div>
                  </div>
                  <div class="DownRightSubBlock">
                    <div class="DownRightButton" @click="openModalPrice(lot)">
                      <button type="reset" class="buttonLot">
                        <span class="buttonLotText">изменить</span>
                      </button>
                    </div>
                    <ModalPrice :isVisiblePrice="modalPrice" :id="pickedId[0]"
                                @closeModalPrice="handleClosePrice"></ModalPrice>
                    <div class="DownRightButton" @click="sendRemoveConfirmation(lot)">
                      <button type="reset" class="buttonLot">
